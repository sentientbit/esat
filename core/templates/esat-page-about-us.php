        ...
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                    <button type="button" class="btn btn-primary btn-lg px-4 me-sm-3">Get ESAT Pro</button>
                    <button type="button" class="btn btn-outline-secondary btn-lg px-4">Visit us</button>
                </div>
            </div>
            <div class="overflow-hidden" style="max-height: 30vh;">
                <div class="container px-5">
                    <img id="" <?php echo 'src="' . ESAT_URL . 'assets/admin/images/sentient-bit-brand.webp' . '" ' ?> class="img-fluid border rounded-3 shadow-lg mb-4" alt="Sentient Bit brand" width="700" loading="lazy">
                </div>
            </div>
        </div>
        <!----------------------------------------------------------------------------->
